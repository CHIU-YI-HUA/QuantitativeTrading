...
class trainModel:
    ...
    def validate_Neutralized_Portfolio       ( self, DataX, DataY, sess, rho_eta, state, isTrain, NumAction, H,W  ):
        ...
        #add at 2023/12/2
        record_buy_sell = np.zeros( (Days, N) )
        ...
        for t in range ( Days - 1 ):
            ...
            for c in range ( N ) :
                ...
                #add at 2023/12/2
                record_buy_sell[t][c] = curAlpha_n[c]
        ...
        return N, posChange, cumAsset, record_buy_sell#add at 2023/12/2
    ...
    def validate_TopBottomK_Portfolio       ( self, DataX, DataY, sess, rho_eta, state, isTrain, NumAction, H,W, K  ):
        ...
        for t in range ( Days - 1 ):
            ...
            for c in range ( N ):
                ...
                #add at 2023/12/2
                record_buy_sell[t][c] = curAlpha_s[c]
    ...
    def Test_TopBottomK_Portfolio   ( self, sess, saver, state, isTrain, rho_eta,  H,W, NumAction, TopK  ):
        ...
        return Outcome[3]#add at 2023/12/2
