...
使用 python yfinance 模組的yf.download()函數下載即時取得股票資料(收盤價)。
# Setup
...
### project.py: 參考來源(Q-learning agent) https://colab.research.google.com/drive/1FzLCI0AO3c7A4bp9Fi01UwXeoc7BN8sW#scrollTo=-SBhFpqZiEfx 
